...
class ShopSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'photo' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/sushi.jpg',
        ...
        $param = [
            ...
            'photo' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/izakaya.jpg',
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now()
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'photo' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/italian.jpg',
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now()
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'region' => '福岡県',
            'genre' => 'ラーメン',
            'description' => 'ラーメン屋とは思えない店内にはカウンター席はもちろん、個室も用意してあります。ラーメンはこってり系・あっさり系ともに揃っています。その他豊富な一品料理やアルコールも用意しており、居酒屋としても利用できます。ぜひご来店をお待ちしております。',	'photo' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/ramen.jpg',
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now()
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'photo' => 'http://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/italian.jpg',
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now()
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'photo' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/ramen.jpg',
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now()
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'photo' => 'http://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/yakiniku.jpg',
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now()
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'photo' => 'http://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/sushi.jpg',
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now()
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'photo' => 'http://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/izakaya.jpg',
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now()
        ];
        DB::table('shops')->insert($param);
